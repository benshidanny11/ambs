                                        ...
                                        <div class="register">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <p>Balance: <?php echo $row_acc['balance'] ?></p>
                                                    <div class="d-flex justify-content-between mt-5">
                                                        <!-- href="delete.php?cid=<?php //echo $_GET['cid'] 
                                                                                    ?>"  -->
                                                        ...
                                                        <a href="reports.php?cid=<?php echo $_GET['cid'] ?>" class="btn btn-success">View transactions</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
